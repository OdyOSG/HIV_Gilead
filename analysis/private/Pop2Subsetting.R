# Script for only Pop2 subsetting

# Population 2 currently does not use subsets, leaving file for clarity.
#
...
# cohortManifest <- getCohortManifest(inputPath = "cohortsToCreate/03_basecohorts")
...
# cohortDefinitionSet$cohortId = cohortDefinitionSet$cohortId +20
#
#

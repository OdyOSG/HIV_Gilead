...
row_names12 <- c("All","15 - 29","30 - 44","45 - 55","55+","Unknown age",
               ...
               "NHW","NHB","Hispanic","AAPI","Other or Unknown"
               )
...
allgroups = c("15 - 29","30 - 44","45 - 55","Age 55+", "NHW","NHB","Hispanic","AAPI")
group ="Age 55+"
...
rownames3 <- c("All","15 - 29","30 - 44","45 - 55","Age 55+",
               "NHW","NHB","Hispanic","AAPI",
               "HIVTest2","AnySTI2","Syph","Chlamydia","Gonnorrhoea","Trichomoniasis",
...
rownames4 <- c("All","15 - 29","30 - 44","45 - 55","Age 55+",
               "NHW","NHB","Hispanic","AAPI",
               "HIVTest2","anySTI2","Syph","Chlamydia","Gonorrhoea","Trichomoniasis",
               "OtherSTI","PWID2","Other2","HIVany2","STIany2", "2HR2","3HR2"
)
